...
import com.example.entity.TableEntity;
...
public class GenUtils {
    ...
    public static List<String> getTemplates(String mybatisType) {
        ...
        templates.add("template/" + mybatisType + "/Entity.java.vm");
        ...
        templates.add("template/" + mybatisType + "/menu.sql.vm");
        templates.add("template/" + mybatisType + "/index.vue.vm");
        templates.add("template/" + mybatisType + "/add-or-update.vue.vm");
        return templates;
    }
    ...
    public static void generatorCode(Map<String, String> table,
                                     List<Map<String, String>> columns, String mybatisType, ZipOutputStream zip) {
        //配置信息
